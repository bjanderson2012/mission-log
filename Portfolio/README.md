...
\- `Case\_Notes/` — 1-page ticket-style case notes (sanitized)
...
\- \*\*Case Note:\*\* \[Case-001 — Home Internet Outage Triage](Case\_Notes/case-001-home-internet-outage-triage.md)
