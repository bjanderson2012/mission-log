...
\- \*\*Command:\*\* `ping <default\_gateway>` (example: `ping 192.168.x.1`)
...
\- \*\*Evidence:\*\* WAN unreachable by IP + tracert fails beyond first upstream hop + provider “known outage” confirmation.
...
\- Command outputs captured (do not include screenshots with personal identifiers).
